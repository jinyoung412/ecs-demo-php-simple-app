...
<input type="text" name="address1" id="address" size="45" required="required" placeholder="Address1"/><br/><br />
<label>City:</label> <br/>
<input type="text" name="city" id="city" size="45" required="required" placeholder="Please Enter Your City"/><br/><br />
<label>State/Province/Region:</label> <br/>
<input type="text" name="state" id="state" size="45" required="required" placeholder="Please Enter Your State"/><br/><br />
<label>ZIP:</label><br/>
<input type="text" name="zip" id="zip" size="45" required="required" placeholder="Please Enter Your Zip Code"/><br/><br />
<label>Country/Region:</label> <br/>
<!--<input type="text" name="country" id="country" required="required" placeholder="Please Enter Your Country"/>-->
...
<input type="text" name="phonenum" id="phonenum" size="45" required="required" placeholder="Please Enter Your Phone Number"/><br/><br />
<input type="checkbox" name="participate" id="participate"/> Participate in Project Mejor?<br/><br />
<input type="checkbox" name="item" id="item"/> Hazardous item<br/> <br />
<input type="text" name="itemlist" id="itemlist" size="45" placeholder="Please Enter Your Hazardous Item"/><br/><br />
<input type="submit" value=" Submit " name="submit" /><br />
<!--<button class="btn-primary">Deliver to this address</button>-->
</form>
</div>
<!-- Right side div -->
<div id="formget">
